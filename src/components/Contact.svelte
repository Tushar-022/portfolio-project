<section class="relative z-0 h-screen bg-black">
  ...
  <div class="flex flex-col h-full items-center justify-evenly text-white">
    <div class="text-center flex flex-col gap-y-4 mobile:gap-y-10">
        <h1 class="text-5xl font-bold font-sans m-2">Let's Connect</h1>
        <div class="flex items-start">
            <p class="text-opacity-80 text-2xl text-white font-light mb-3">
                Tushar Khandelwal
                <br />
                I'm a sophomore at Nit Jalandhar pursuing BTech in Information Technology(2025).
                <br/>
                 I have my expertise in Data Structures and Algorithms and web development (MERN stack).
            </p>
        </div>
        <p>
            Want to discuss the next big thing? Hire me? or develop a project with me?
            <br />
    ...
    <div class="flex flex-col mt-4 items-center">
        ...
        <div class="flex gap-x-7 m-10">
            <button class="bg-blue-500 text-white px-8 py-3 text-base rounded-full shadow-md hover:bg-blue-700 transition duration-300"
                ...
                data-blobity-tooltip="Contact via Linkedin"
            >
                Connect on LinkedIn
            </button>
            ...
            <button class="bg-orange-500 text-white px-8 py-3 text-base rounded-full shadow-md hover:bg-orange-700 transition duration-300"
                ...
                data-blobity-tooltip="View Leetcode Profile"
            >
                Leetcode Profile
            </button>
